...
public class Approval {
    ...
    private String superiorContactNo = "";
    ...
    public String getSuperiorContactNo() {
        return superiorContactNo;
    }

    public void setSuperiorContactNo(String superiorContactNo) {
        this.superiorContactNo = superiorContactNo;
    }
