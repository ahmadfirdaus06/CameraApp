...
import com.example.cameraapp.miscellanous.AutoFitTextureView;
...
public class Camera2BasicFragment extends Fragment
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(@NonNull CameraDevice cameraDevice) {
            // This method is called when the camera is opened.  We startGetData camera preview here.
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        String fileName = "SEMMS_" + timeStamp + ".jpg";
    ...
    public void onResume() {
        ...
        // a camera and startGetData preview from here (otherwise, we wait until the surface is ready in
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            // This is the output Surface we need to startGetData preview.
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface, mImageReader.getSurface()),
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            // When the session is ready, we startGetData displaying the preview.
                            ...
                            try {
                                ...
                                // Finally, we startGetData displaying the camera preview.
